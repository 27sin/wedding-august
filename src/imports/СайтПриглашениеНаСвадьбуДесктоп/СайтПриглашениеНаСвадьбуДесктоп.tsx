    ...
    <div className="bg-[#FAFBF9] min-h-screen w-full">
      ...
      <section className="bg-[#FAFBF9] py-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-xl border-2 border-[rgba(82,88,52,0.1)] p-12">
            ...
            <div className="rounded-lg h-80 mb-6 overflow-hidden">
              <iframe
          ...
          <div className="space-y-14">
            {[
              ...
              <div key={i} className="flex gap-12 items-start">
                <div className="text-[#525834] text-5xl font-['Playfair_Display'] font-semibold w-48 text-right">
                  {item.time}
                </div>
      ...
      <section className="bg-[#FAFBF9] py-20 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-[#4b4d4d] text-lg text-center mb-12 leading-relaxed">
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-[#cbe1b7] rounded-xl overflow-hidden grid grid-cols-3 divide-x divide-[#afb785]">
            <div className="p-8 text-center">
              <h3 className="text-[#525834] text-xl font-['Playfair_Display'] font-semibold mb-4">
                Подарки
              </h3>
              <p className="text-[#4b4d4d] text-sm leading-relaxed">
                Лучший подарок для нас — это ваше присутствие!<br />
            ...
            <div className="p-8 text-center">
              ...
              <p className="text-[#4b4d4d] text-sm leading-relaxed">
                Знаем, что на свадьбу принято дарить цветы.<br />
      ...
      <section className="bg-[#FAFBF9] py-20 px-4">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-[#4b4d4d] text-lg leading-relaxed mb-8">
