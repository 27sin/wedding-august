    ...
    <div className="bg-white min-h-screen w-full">
      ...
      <section className="bg-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-[rgba(180,197,165,0.05)] rounded-xl border border-[rgba(82,88,52,0.1)] p-8">
      ...
      <section className="bg-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 gap-4">
            <img src={imgImage14} alt="Образ 1" className="rounded-lg shadow-lg w-full" />
            <img src={imgImage16} alt="Образ 2" className="rounded-lg shadow-lg w-full" />
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-20 px-4">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="bg-[rgba(203,225,183,0.05)] rounded-xl border border-[rgba(82,88,52,0.1)] p-8">
